          ...
          <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4">
                ...
                <a
                  href="#"
                  class="ml-8 font-medium text-purple-600 hover:text-purple-900 focus:outline-none focus:text-purple-700 transition duration-150 ease-in-out"
                >Log in</a>
              </div>
            </nav>
          </div>
              ...
              <div class="rounded-lg shadow-md">
                <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                  <div class="px-5 pt-4 flex items-center justify-between">
                    <div>
                      <img class="h-8 w-auto" src="@/assets/images/webidacta-logo.svg" alt />
                    </div>
                    <div class="-mr-2">
                      <button
                        type="button"
          ...
          >
            <div class="sm:text-center lg:text-left">
              ...
              >
                Data to enrich your
                <br class="xl:hidden" />
                <span class="text-purple-600">online business</span>
              </h2>
              <p
              ...
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div class="rounded-md shadow">
                  <a
                    href="#"
                    class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-purple-600 hover:bg-purple-500 focus:outline-none focus:shadow-outline-purple transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10"
                  >Get started</a>
                </div>
    ...
    <div class="bg-gray-50">
      ...
      >
        ...
        >
          Ready to dive in?
          <br />
          <span class="text-purple-600">Start your free trial today.</span>
        </h2>
        <div class="mt-8 flex lg:flex-shrink-0 lg:mt-0">
          <div class="inline-flex rounded-md shadow">
            <a
              href="#"
              class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-purple-600 hover:bg-purple-500 focus:outline-none focus:shadow-outline-purple transition duration-150 ease-in-out"
            >Get started</a>
          </div>
          <div class="ml-3 inline-flex rounded-md shadow">
            <a
              href="#"
              class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-purple-600 bg-white hover:text-purple-500 focus:outline-none focus:shadow-outline-purple transition duration-150 ease-in-out"
            >Learn more</a>
          </div>
        </div>
      </div>
